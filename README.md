...
К сожалению предотвратить причины задержек не всегда представляется возможным, однако клиент имеет возможность избежать потерь времени, просто прервав **TCP** соединение с удаленным серверов по истечении указанного интервала.
