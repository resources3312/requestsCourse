...
Из этого можно заключить, что версия 1.0 протокола HTTP была без сомнений революционной для своего времени, и продолжила свою эволюцию несмотря на наличие проблем связанных с использованием синхронной передачи данных через протокол TCP
#### HTTP/1.1
